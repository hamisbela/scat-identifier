          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Have questions about our scat identifier? Need help understanding an animal analysis? 
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:support@example.com" className="text-green-600 hover:text-green-800">
                    support@example.com
                  </a>
                </div>
                <div className="flex items-center gap-3">
